...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[KM_QWERTY] = LAYOUT( \
		...
		LT(LAYER1,KC_ESC), LT(LAYER3,KC_A),   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   LT(LAYER2,KC_SCLN),TD(TD_END),CTL_T(KC_ENT),              \
		KC_LSPO, KC_NUBS,   KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,KC_COMM,KC_DOT, KC_SLSH,        KC_RSPC,          KC_UP,              \
		KC_LCTL, KC_LGUI,   KC_LALT,                       KC_SPC,                          KC_RALT,KC_RGUI,TG(GAMING),KC_FN0,   KC_LEFT,KC_DOWN,KC_RGHT),	
	...
	[GAMING] = LAYOUT( \
		...
		KC_LSPO, KC_NUBS,   KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,KC_COMM,KC_DOT, KC_SLSH,        KC_RSPC,          KC_UP,              \
		KC_LCTL, KC_LGUI,   KC_LALT,                       KC_SPC,                          KC_RALT,KC_RGUI,_______,_______,   KC_LEFT,KC_DOWN,KC_RGHT),
